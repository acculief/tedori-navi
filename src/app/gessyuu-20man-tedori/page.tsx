...
export const metadata: Metadata = {
  title: "月収20万円の手取りはいくら？額面別の早見表",
  description:
    "月収20万円（額面）の手取りは約16.0万円。年収に換算すると240万円で年間手取りは約192万円です。天引きの内訳、月収18〜24万円の早見表、家族構成別の手取りをわかりやすく解説します。",
  alternates: { canonical: "/gessyuu-20man-tedori/" },
};

const faqs = [
  {
    q: "月収20万円の手取りはいくらですか？",
    a: "額面（総支給）で月20万円の場合、手取りは約16.0万円です。健康保険・厚生年金・雇用保険と所得税・住民税で毎月約4.0万円が天引きされます（独身・40歳未満・協会けんぽ加入・賞与なしの概算）。",
  },
  {
    q: "月収20万円は年収いくらですか？",
    a: "賞与なしなら月20万円×12か月で年収240万円です。賞与が年2回・計4か月分ある場合は年収約320万円になります。年収が上がる分、年間の手取り総額も増えます。",
  },
  {
    q: "月収20万円で一人暮らしはできますか？",
    a: "手取り約16.0万円のうち家賃を5万円前後に抑えれば、地方はもちろん都市部でも一人暮らしは可能です。固定費（家賃・通信・保険）を手取りの5割以内に収めると、貯蓄に回す余裕も生まれます。",
  },
];
  ...
  return (
    <article className="mx-auto max-w-2xl px-4 py-10">
      ...
      <p className="mt-6 text-sm leading-relaxed text-gray-700 sm:text-base">
        額面（総支給）で月収20万円の場合、<strong>手取りは約16.0万円</strong>です。
        毎月<strong>約4.0万円</strong>が税金と社会保険料として天引きされます（独身・40歳未満・協会けんぽ加入・賞与なしの概算）。
        年収に換算すると240万円で、年間の手取りは約192万円です。この記事では天引きの内訳と、月収別・家族構成別の手取りを見ていきます。
      </p>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        額面20万円から毎月引かれる内訳は次のとおりです（独身・賞与なし想定を12で割った目安）。
      </p>
        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-gray-200 px-3 py-2">約1.00万円</td>
            </tr>
            <tr className="bg-gray-50">
              <td className="border border-gray-200 px-3 py-2">厚生年金保険料</td>
              <td className="border border-gray-200 px-3 py-2">約1.83万円</td>
            </tr>
            <tr>
              <td className="border border-gray-200 px-3 py-2">雇用保険料</td>
              <td className="border border-gray-200 px-3 py-2">約0.12万円</td>
            </tr>
            <tr className="bg-gray-50">
              <td className="border border-gray-200 px-3 py-2">所得税</td>
              <td className="border border-gray-200 px-3 py-2">約0.33万円</td>
            </tr>
            <tr>
              <td className="border border-gray-200 px-3 py-2">住民税</td>
              <td className="border border-gray-200 px-3 py-2">約0.73万円</td>
            </tr>
            <tr className="bg-primary-50 font-bold">
              <td className="border border-gray-200 px-3 py-2">天引き合計</td>
              <td className="border border-gray-200 px-3 py-2">約4.01万円</td>
            </tr>
            <tr className="font-bold">
              <td className="border border-gray-200 px-3 py-2">手取り</td>
              <td className="border border-gray-200 px-3 py-2">約16.0万円</td>
            </tr>
          </tbody>
        </table>
      </div>
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        もっとも大きいのは<strong>厚生年金保険料</strong>で、健康保険と合わせた社会保険料が天引きの約7割を占めます。所得税は月あたり約0.33万円と少なく、この年収帯では社会保険料の負担が手取りを大きく左右します。
      </p>
      ...
      <div className="mt-4 overflow-x-auto">
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            {[
              ["18万円", "約14.5万円", "216万円", "80.3%"],
              ["19万円", "約15.2万円", "228万円", "80.1%"],
              ["20万円", "約16.0万円", "240万円", "80.0%"],
              ["21万円", "約16.8万円", "252万円", "79.8%"],
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        同じ月収20万円（年収240万円）でも、配偶者控除や扶養控除の有無で手取りは変わります。
      </p>
      <div className="mt-4 overflow-x-auto">
        <table className="w-full border-collapse text-sm">
          <thead>
          ...
          <tbody>
            {[
              ["独身", "約16.0万円", "約192万円", "80.0%"],
              ["片働き夫婦", "約16.4万円", "約197万円", "82.2%"],
              ["夫婦＋子1人", "約16.9万円", "約202万円", "84.3%"],
            ].map((row, i) => (
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        配偶者を扶養する「片働き夫婦」は独身より年間で約5万円、16歳以上の子も扶養する「夫婦＋子1人」では約10万円、手取りが多くなります。
      </p>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        月収20万円でも賞与の有無で年収は大きく変わります。賞与にも社会保険料と税金がかかるため、額面がそのまま手取りになるわけではありません。
      </p>
      <div className="mt-4 overflow-x-auto">
        <table className="w-full border-collapse text-sm">
          <thead>
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-gray-200 px-3 py-2">240万円</td>
              <td className="border border-gray-200 px-3 py-2">約192万円</td>
            </tr>
            <tr className="bg-gray-50">
              <td className="border border-gray-200 px-3 py-2">年2回・計2か月分</td>
              <td className="border border-gray-200 px-3 py-2">約280万円</td>
              <td className="border border-gray-200 px-3 py-2">約223万円</td>
            </tr>
            <tr>
              <td className="border border-gray-200 px-3 py-2">年2回・計4か月分</td>
              <td className="border border-gray-200 px-3 py-2">約320万円</td>
              <td className="border border-gray-200 px-3 py-2">約253万円</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="mt-8 rounded-2xl bg-primary-50 p-6 text-center">
        ...
        <p className="mt-1 text-sm text-gray-600">
          月収20万円以外でも、年収を入力するだけで手取り・税金の内訳がわかります。
        </p>
