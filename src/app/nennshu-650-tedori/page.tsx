...
export const metadata: Metadata = {
  ...
  description:
    "年収650万円の手取りは約496万円、月の手取りは約41万円。額面との差154万円の税金・社会保険料の内訳や、家族構成別・ボーナスあり別の手取りを早見表でわかりやすく解説します。",
...
const faqs = [
  ...
  {
    q: "年収600万円と650万円で手取りはどれくらい違いますか？",
    a: "年収600万円の手取りは約460万円、650万円は約496万円で、額面が50万円増えると手取りは約36万円増えます。差の約14万円は増えた分にかかる税金と社会保険料です。",
  },
  {
    q: "年収650万円は高い方ですか？",
    a: "国税庁の民間給与実態統計調査では給与所得者の平均年収は約460万円前後です。年収650万円は平均を4割ほど上回る水準で、上位2〜3割に入る年収帯といえます。",
  },
];
  ...
  return (
    <article className="mx-auto max-w-2xl px-4 py-10">
      ...
      <p className="mt-6 text-sm leading-relaxed text-gray-700 sm:text-base">
        ...
        額面の650万円との差、約154万円は税金と社会保険料として天引きされています。この記事では、その内訳と家族構成・ボーナス別の手取りを詳しく見ていきます。
      </p>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        天引きのうち、もっとも大きいのは<strong>社会保険料</strong>の約96万円です。税金（所得税＋住民税）の合計約59万円よりも社会保険料の負担が大きく、これは年収が上がっても変わらない特徴です。なお所得税は年収650万円のあたりで税率10％の区分に入り、年収が上がるほど所得税の伸びが大きくなっていきます。
      </p>
        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            {[
              ...
              ["片働き夫婦", "約503万円", "約42万円", "77.4%"],
              ["夫婦＋子1人", "約510万円", "約43万円", "78.5%"],
            ].map((row, i) => (
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        配偶者を扶養している「片働き夫婦」は独身より手取りが約7万円多く、さらに16歳以上の子を扶養する「夫婦＋子1人」では約14万円多くなります。年収650万円は配偶者控除が満額適用される所得帯なので、控除の効果がそのまま手取り差に表れます。
      </p>
