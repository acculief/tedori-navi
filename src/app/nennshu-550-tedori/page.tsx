...
export const metadata: Metadata = {
  title: "年収550万円の手取りはいくら？内訳と早見表",
  description:
    "年収550万円の手取りは約424万円、月の手取りは約35万円。額面との差126万円の税金・社会保険料の内訳や、家族構成別・ボーナスあり別の手取りを早見表でわかりやすく解説します。",
  alternates: { canonical: "/nennshu-550-tedori/" },
};

const faqs = [
  {
    q: "年収550万円の手取りは月いくらですか？",
    a: "独身の場合、年間の手取りは約424万円で、12で割ると月あたり約35万円です。ボーナスがある場合は毎月の手取りはこれより少なくなり、その分ボーナス月にまとまって支給されます。",
  },
  {
    q: "年収500万円と550万円で手取りはどれくらい違いますか？",
    a: "年収500万円の手取りは約388万円、550万円は約424万円で、額面が50万円増えると手取りは約36万円増えます。差の約14万円は増えた分にかかる税金と社会保険料です。",
  },
  {
    q: "年収550万円は高い方ですか？",
    a: "国税庁の民間給与実態統計調査では給与所得者の平均年収は約460万円前後です。年収550万円は平均を1割ほど上回る水準といえます。",
  },
];
  ...
  return (
    <article className="mx-auto max-w-2xl px-4 py-10">
      ...
      <p className="mt-6 text-sm leading-relaxed text-gray-700 sm:text-base">
        年収550万円の<strong>手取りは約424万円</strong>、月あたりにすると
        <strong>約35万円</strong>です（独身・40歳未満・協会けんぽ加入の概算）。
        額面の550万円との差、約126万円は税金と社会保険料として天引きされています。この記事では、その内訳と家族構成・ボーナス別の手取りを詳しく見ていきます。
      </p>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        額面550万円から差し引かれる内訳は次のとおりです（独身の場合）。
      </p>
        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-gray-200 px-3 py-2">約81.1万円</td>
            </tr>
            <tr className="bg-gray-50">
              <td className="border border-gray-200 px-3 py-2">所得税</td>
              <td className="border border-gray-200 px-3 py-2">約17.3万円</td>
            </tr>
            <tr>
              <td className="border border-gray-200 px-3 py-2">住民税</td>
              <td className="border border-gray-200 px-3 py-2">約27.8万円</td>
            </tr>
            <tr className="bg-primary-50 font-bold">
              <td className="border border-gray-200 px-3 py-2">天引き合計</td>
              <td className="border border-gray-200 px-3 py-2">約126.2万円</td>
            </tr>
            <tr className="font-bold">
              <td className="border border-gray-200 px-3 py-2">手取り</td>
              <td className="border border-gray-200 px-3 py-2">約423.8万円</td>
            </tr>
          </tbody>
        </table>
      </div>
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        天引きのうち、もっとも大きいのは<strong>社会保険料</strong>の約81万円です。税金（所得税＋住民税）の合計約45万円よりも社会保険料の負担がはるかに大きく、これは年収が上がっても変わらない特徴です。
      </p>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        同じ年収550万円でも、配偶者控除や扶養控除の有無で手取りは変わります。
      </p>
      <div className="mt-4 overflow-x-auto">
        <table className="w-full border-collapse text-sm">
          <thead>
          ...
          <tbody>
            {[
              ["独身", "約424万円", "約35万円", "77.1%"],
              ["片働き夫婦", "約431万円", "約36万円", "78.4%"],
              ["夫婦＋子1人", "約436万円", "約36万円", "79.3%"],
            ].map((row, i) => (
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        年間手取り約424万円（独身）を、ボーナスの有無でどう受け取るかによって毎月の手取りは変わります。
      </p>
      <div className="mt-4 overflow-x-auto">
        <table className="w-full border-collapse text-sm">
          <thead>
          ...
          <tbody>
            ...
            <tr className="bg-gray-50">
              ...
              <td className="border border-gray-200 px-3 py-2">約26万円</td>
              <td className="border border-gray-200 px-3 py-2">約53万円 × 年2回</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="mt-8 rounded-2xl bg-primary-50 p-6 text-center">
        ...
        <p className="mt-1 text-sm text-gray-600">
          550万円以外の年収も、入力するだけで手取り・税金の内訳がわかります。
        </p>
