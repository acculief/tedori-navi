...
export const metadata: Metadata = {
  title: "年収400万円の手取りはいくら？月収・ボーナス別の早見表",
  description:
    "年収400万円の手取りは約314万円、月の手取りは約26万円。独身・夫婦・子ありの家族構成別や、ボーナスあり・なしの月収別に手取り額を早見表でわかりやすく解説します。",
  alternates: { canonical: "/nennshu-400-tedori/" },
};

const faqs = [
  {
    q: "年収400万円の手取りは月いくらですか？",
    a: "独身の場合、年間の手取りは約314万円で、12で割ると月あたり約26万円です。ボーナスがある場合は毎月の手取りはこれより少なくなり、その分ボーナス月にまとまって支給されます。",
  },
  {
    q: "年収400万円は平均より高いですか？",
    a: "国税庁の民間給与実態統計調査では給与所得者の平均年収は約460万円前後です。年収400万円は平均をやや下回る水準といえます。",
  },
  {
    q: "扶養家族がいると手取りは増えますか？",
    a: "はい。配偶者控除や扶養控除が適用されると課税所得が下がり、所得税・住民税が軽くなります。年収400万円では、独身より子ありの方が年間で約10万円手取りが増えます。",
  },
];
  ...
  return (
    <article className="mx-auto max-w-2xl px-4 py-10">
      ...
      <p className="mt-6 text-sm leading-relaxed text-gray-700 sm:text-base">
        年収400万円の<strong>手取りは約314万円</strong>、月あたりにすると
        <strong>約26万円</strong>です（独身・40歳未満・協会けんぽ加入の概算）。
        額面の400万円との差、約86万円は税金と社会保険料として天引きされています。この記事では、その内訳と家族構成・ボーナス別の手取りを詳しく見ていきます。
      </p>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        額面400万円から差し引かれる内訳は次のとおりです（独身の場合）。
      </p>
        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-gray-200 px-3 py-2">約59.0万円</td>
            </tr>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        天引きのうち、もっとも大きいのは<strong>社会保険料</strong>です。税金（所得税＋住民税）の合計約26.6万円に対し、社会保険料は59.0万円と2倍以上を占めます。年収400万円の手取りを増やしたいなら、まず社会保険料の仕組みを知ることが近道です。
      </p>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        年収400万円で天引きされる社会保険料59.0万円の内訳は次のとおりです（従業員負担分）。
      </p>
      <div className="mt-4 overflow-x-auto">
        <table className="w-full border-collapse text-sm">
          <thead>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        もっとも負担が大きいのは厚生年金です。40歳以上になると、これに介護保険料（約1.6%）が上乗せされるため、同じ年収でも手取りはさらに数万円減ります。
      </p>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        同じ年収400万円でも、配偶者控除や扶養控除の有無で手取りは変わります。
      </p>
      <div className="mt-4 overflow-x-auto">
        <table className="w-full border-collapse text-sm">
          <thead>
          ...
          <tbody>
            {[
              ["独身", "約314万円", "約26万円", "78.6%"],
              ["片働き夫婦", "約320万円", "約27万円", "79.9%"],
              ["夫婦＋子1人", "約325万円", "約27万円", "81.2%"],
            ].map((row, i) => (
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        配偶者を扶養している「片働き夫婦」は独身より手取りが約5万円多く、さらに16歳以上の子を扶養する「夫婦＋子1人」では約10万円多くなります。
      </p>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        年間手取り約314万円（独身）を、ボーナスの有無でどう受け取るかによって毎月の手取りは変わります。
      </p>
      <div className="mt-4 overflow-x-auto">
        <table className="w-full border-collapse text-sm">
          <thead>
          ...
          <tbody>
            ...
            <tr className="bg-gray-50">
              ...
              <td className="border border-gray-200 px-3 py-2">約39万円 × 年2回</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="mt-8 rounded-2xl bg-primary-50 p-6 text-center">
        ...
        <p className="mt-1 text-sm text-gray-600">
          400万円以外の年収も、入力するだけで手取り・税金の内訳がわかります。
        </p>
