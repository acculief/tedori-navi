...
export const metadata: Metadata = {
  title: "月収45万円の手取りはいくら？額面別の早見表",
  description:
    "月収45万円（額面）の手取りは約34.7万円。年収に換算すると540万円で年間手取りは約417万円です。天引きの内訳、月収40〜50万円の早見表、家族構成別・賞与ありの手取りをわかりやすく解説します。",
  alternates: { canonical: "/gessyuu-45man-tedori/" },
};

const faqs = [
  {
    q: "月収45万円の手取りはいくらですか？",
    a: "額面（総支給）で月45万円の場合、手取りは約34.7万円です。健康保険・厚生年金・雇用保険と所得税・住民税で毎月約10.3万円が天引きされます（独身・40歳未満・協会けんぽ加入・賞与なしの概算）。",
  },
  {
    q: "月収45万円は年収いくらですか？",
    a: "賞与なしなら月45万円×12か月で年収540万円です。賞与が年2回・計4か月分ある場合は年収約720万円になります。年収が上がる分、年間の手取り総額も増えます。",
  },
  {
    q: "月収45万円で手取りを増やす方法はありますか？",
  ...
  return (
    <article className="mx-auto max-w-2xl px-4 py-10">
      ...
      <p className="mt-6 text-sm leading-relaxed text-gray-700 sm:text-base">
        額面（総支給）で月収45万円の場合、<strong>手取りは約34.7万円</strong>です。
        毎月<strong>約10.3万円</strong>が税金と社会保険料として天引きされます（独身・40歳未満・協会けんぽ加入・賞与なしの概算）。
        年収に換算すると540万円で、年間の手取りは約417万円です。この記事では天引きの内訳と、月収別・家族構成別の手取り、賞与がある場合の手取りを見ていきます。
      </p>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        額面45万円から毎月引かれる内訳は次のとおりです（独身・賞与なし想定を12で割った目安）。
      </p>
        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-gray-200 px-3 py-2">約2.3万円</td>
            </tr>
            <tr className="bg-gray-50">
              <td className="border border-gray-200 px-3 py-2">厚生年金保険料</td>
              <td className="border border-gray-200 px-3 py-2">約4.1万円</td>
            </tr>
            <tr>
              <td className="border border-gray-200 px-3 py-2">雇用保険料</td>
              <td className="border border-gray-200 px-3 py-2">約0.3万円</td>
            </tr>
            <tr className="bg-gray-50">
              <td className="border border-gray-200 px-3 py-2">所得税</td>
              <td className="border border-gray-200 px-3 py-2">約1.4万円</td>
            </tr>
            <tr>
            ...
            <tr className="bg-primary-50 font-bold">
              ...
              <td className="border border-gray-200 px-3 py-2">約10.3万円</td>
            </tr>
            <tr className="font-bold">
              <td className="border border-gray-200 px-3 py-2">手取り</td>
              <td className="border border-gray-200 px-3 py-2">約34.7万円</td>
            </tr>
          </tbody>
        </table>
      </div>
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        もっとも大きいのは<strong>厚生年金保険料</strong>で、健康保険と合わせた社会保険料が天引きの約6.4割を占めます。税金（所得税＋住民税）は月あたり約3.7万円で、月収40万円の頃より所得税・住民税ともに負担が増えているのが特徴です。
      </p>
        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            {[
              ...
              ["42万円", "約32.6万円", "504万円", "77.5%"],
              ["45万円", "約34.7万円", "540万円", "77.1%"],
              ["48万円", "約36.9万円", "576万円", "76.8%"],
              ["50万円", "約38.3万円", "600万円", "76.6%"],
            ].map((row, i) => (
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        額面が上がるほど手取り率はわずかに下がります。所得税が超過累進課税で、収入が増えた部分ほど高い税率がかかるためです。月収45万円は年収540万円にあたり、所得税率10%の区分の中ほどに位置します。
      </p>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        同じ月収45万円でも、配偶者控除や扶養控除の有無で手取りは変わります。
      </p>
      <div className="mt-4 overflow-x-auto">
        <table className="w-full border-collapse text-sm">
          <thead>
          ...
          <tbody>
            {[
              ["独身", "約34.7万円", "約417万円", "77.1%"],
              ["片働き夫婦", "約35.3万円", "約424万円", "78.5%"],
              ["夫婦＋子1人", "約35.9万円", "約430万円", "79.7%"],
            ].map((row, i) => (
              <tr key={row[0]} className={i % 2 ? "bg-gray-50" : ""}>
                {row.map((c, j) => (
                  <td key={j} className="border border-gray-200 px-3 py-2">
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        配偶者を扶養する「片働き夫婦」は独身より年約7万円、16歳以上の子も扶養する「夫婦＋子1人」では年約13万円手取りが多くなります。控除で課税所得が下がり、所得税・住民税が軽くなるためです。
      </p>
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-700">
        月収45万円に加えて賞与が年2回・計4か月分（180万円）出る場合、年収は約720万円になります。この場合の年間手取りは約540万円（手取り率74.9%）で、毎月の手取り約34.7万円は変わらず、賞与月にまとまった金額が加わるイメージです。賞与にも社会保険料と所得税がかかるため、額面180万円がそのまま手取りに加わるわけではなく、おおむね7〜8割が手取りとして残ります。
      </p>
